...
import avatar from 'public/images/pervoklasnik/pervoklasnin 1.png';
import TextCustomField from '@components/text-custom-field/TextCustomField';
import SimpleSelect, {Option} from '@components/simple-select/SimpleSelect';
        ...
        <div className={styles.table}>
          <form>
            <Controller
              name="middleName"
              render={({field}) => (
                <TextCustomField {...field} label="Фамилия:" width = "400px" error={errors.middleName?.message}/>
              )}
              control={control}
            />
            <Controller
              name="firstName"
              render={({field}) => (
                <TextCustomField {...field} label="Имя:" width = "400px" error={errors.firstName?.message}/>
              )}
              control={control}
            />
            <Controller
              name="lastName"
              render={({field}) => (
                <TextCustomField {...field} label="Отчество:" width = "400px" error={errors.lastName?.message}/>
              )}
              control={control}
            />
            ...
            <Controller
              name="city"
              render={({field}) => (
                <TextCustomField {...field} label="Город:" width = "400px" error={errors.city?.message}/>
              )}
              control={control}
            />
            <Controller
              name="phone"
              render={({field}) => (
                <TextCustomField {...field} label="Телефон:" width = "400px" error={errors.phone?.message}/>
              )}
              control={control}
            />
            <div className={styles.table__row}>
              <div className={styles.table__column}>
                <div className={styles.table__birthdate}><Controller
                  name="birthdate"
                  render={({field}) => <TextCustomField width="140px" {...field} label="Дата рождения:"
                ...
                <div className={styles.table__payform}>
                  ...
                  name="payForm"
                  render={({field}) => (
                    <TextCustomField {...field} width="95px" label="Оплачено с:" error={errors.payForm?.message}/>
                  )}
                  control={control}
                />
                </div>
              ...
              <div className={styles.table__column}>
                ...
                <Controller
                  name="email"
                  render={({field}) => (
                    <TextCustomField {...field} width = "140px" label="Почта:" error={errors.email?.message}/>
                  )}
                  control={control}
                />
                </div>
                ...
                <Controller
                  name="payBy"
                  render={({field}) => (
                    <TextCustomField ln={ 1} {...field} width = "95px" label="Оплачено по:" error={errors.payBy?.message}/>
                  )}
                  control={control}
                />
                </div>
