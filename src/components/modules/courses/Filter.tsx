...
interface FilterProps {
  onChange: (filter: Nullable<CourseFilterViewModel>) => void;
}
              ...
              <Grid item xs={12} sm={4}>
                <FormControl fullWidth size="small">
                  ...
                  >
                    ...
                    <MenuItem value={GroupLevel.easy}>{GroupLevel.easy}</MenuItem>
                    <MenuItem value={GroupLevel.medium}>{GroupLevel.medium}</MenuItem>
                    <MenuItem value={GroupLevel.hard}>{GroupLevel.hard}</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
              <Grid item xs={12} sm={4}>
