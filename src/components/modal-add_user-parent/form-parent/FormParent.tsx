...
import Icon from 'public/images/pervoklasnik/Icon.png'
          ...
          <div className={styles.table}>
            <form>
                ...
                <div>
                  <div className={styles.table__city}>
                    <Controller
                      name="city"
                      render={({field}) => (
                        <TextCustomField {...field} ln={1} label="Город:" width="140px" error={errors.city?.message}/>
                      )}
                      control={control}
                    />
                  </div>
              ...
              <Controller
                name="email"
                render={({field}) => (
                  <TextCustomField {...field} width="240px" label="Почта:" error={errors.email?.message}/>
                )}
                control={control}
              />
                <RadioInput />
