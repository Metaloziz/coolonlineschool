...
import cl from 'src/components/elements/teacher-comment/TeacherComment.module.scss';
...
const TeacherComment: FC<ITeacherComment> = ({ comment, commentDate, className }) => (
