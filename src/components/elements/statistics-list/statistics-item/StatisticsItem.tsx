...
import CustomDoughnut from '@components/elements/custom-doughnut/CustomDoughnut';
import play from '@svgs/button/play.svg';
import cn from 'classnames';
import Image from 'next/image';
import styles from 'src/components/elements/statistics-list/statistics-item/StatisticsItem.module.scss';
